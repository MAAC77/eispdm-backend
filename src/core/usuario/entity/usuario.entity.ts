...
import { HorarioUsuario } from 'src/application/asistencia/entity/horario-usuario.entity'
import { Marcacion } from 'src/application/asistencia/entity/marcacion.entity'
...
export class Usuario extends AuditoriaEntity {
  ...
  @OneToMany(() => HorarioUsuario, (horarioUsuario) => horarioUsuario.usuario)
  usuarioHorario: HorarioUsuario[]

  @OneToMany(() => Marcacion, (marcacion) => marcacion.usuario)
  usuarioMarcacion: Marcacion[]
